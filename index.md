# seerSurv ![seerSurv hex sticker](reference/figures/logo.png)

## Overview

**seerSurv** provides a transparent, reproducible framework for deriving
monthly cancer-recurrence **transition probabilities** used in
state-transition health economic models.

Given five-year aggregate survival proportions for **local/regional
recurrence (LR)** and **distant recurrence (DR)** populations—typically
...
> Survival Data: An R Package for Health Economic Evaluations.” *Value
> in Health* (submitted).
...
Murat Kurt. See [LICENSE](https://heorlytics.github.io/seerSurv/LICENSE)
for details.
